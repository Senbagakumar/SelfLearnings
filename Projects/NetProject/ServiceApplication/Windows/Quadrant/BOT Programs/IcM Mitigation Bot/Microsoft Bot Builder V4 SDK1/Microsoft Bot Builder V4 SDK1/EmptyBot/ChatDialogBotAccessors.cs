...
namespace ChatBot
{
    ...
    ///  - See <see cref="ChatDialogBot"/> constructor for how that is injected.
    ///  - See the Startup.cs file for more details on creating the Singleton that gets
    ///    injected into the constructor.
    /// </summary>
    public class ChatDialogBotAccessors
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatDialogBotAccessors"/> class.
        ...
        public ChatDialogBotAccessors(ConversationState conversationState, UserState userState)
        {
