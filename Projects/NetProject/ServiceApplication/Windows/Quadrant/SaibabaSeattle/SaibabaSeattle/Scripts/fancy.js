    ...
    i.extend(r, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                closeBtn: '<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"><span class="stl-btn"><i class="ion ion-close-round"></i></span></a>',
                next: '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span class="stl-btn"><i class="ion ion-ios-arrow-forward"></i></span></a>',
                prev: '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span class="stl-btn"><i class="ion ion-ios-arrow-back"></i></span></a>'
            },
            openEffect: "fade",
            openSpeed: 250,
            openEasing: "swing",
