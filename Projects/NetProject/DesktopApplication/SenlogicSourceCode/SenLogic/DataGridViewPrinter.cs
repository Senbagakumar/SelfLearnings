...
namespace SenLogic
{
    public class DataGridViewPrinter
    {
        ...
        private bool IsWithfooter;//Determine the page contain With footer or not
        private string TheFottertext;//The Footer Text
        ...
        private bool AllwTitle;//Determine The all pages contain Header and footer or not
        static int headerf;//flag The Title shold print in every page or not
        private bool Withgrid;//flag for grid line print
        ...
        public DataGridViewPrinter(DataGridView aDataGridView, PrintDocument aPrintDocument, bool CenterOnPage, bool WithTitle, string aTitleText, bool WithFooter, string aFooter, Font aTitleFont, Color aTitleColor, bool WithPaging, bool allpage, bool gridline)
        {
            ...
            IsWithfooter = WithFooter;
            TheFottertext = aFooter;
            AllwTitle = allpage;
            Withgrid = gridline;
        ...
        private void Calculate(Graphics g)
        {
            if (PageNumber == 0) // Just calculate once
            {
                ...
                for (int i = 0; i < TheDataGridView.Columns.Count; i++)
                {
                    ...
                    //tmpFont = new System.Drawing.Font("Arial", 13);
                    ...
                    for (int j = 0; j < TheDataGridView.Rows.Count; j++)
                    {
                        ...
                        //tmpFont = new System.Drawing.Font("Thoma", 13);
        ...
        private void DrawHeader(Graphics g)
        {
            ...
            if (true)
            {
                ...
                //Font HeaderFont = new System.Drawing.Font("Arial", 13);
        ...
        private bool DrawRows(Graphics g)
        {
            ...
            while (CurrentRow < TheDataGridView.Rows.Count)
            {
                ...
                if (TheDataGridView.Rows[CurrentRow].Visible) // Print the cells of the CurrentRow only if that row is visible
                {
                    ...
                    //RowFont = new System.Drawing.Font("Arial",12,FontStyle.Bold );
                    ...
                    //For Even Rows Color Difference
                    ...
                    for (int CurrentCell = (int)mColumnPoints[mColumnPoint].GetValue(0); CurrentCell < (int)mColumnPoints[mColumnPoint].GetValue(1); CurrentCell++)
                    {
                        ...
                        //Drawing the cell bounds
                        if (/*TheDataGridView.CellBorderStyle != DataGridViewCellBorderStyle.None&&*/Withgrid) // Draw the cell border only if the CellBorderStyle is not None
            ...
            if (IsWithfooter && CurrentRow == TheDataGridView.Rows.Count)
            {
                StringFormat TitleFormat = new StringFormat();
                TitleFormat.Trimming = StringTrimming.Word;
                TitleFormat.FormatFlags = StringFormatFlags.NoWrap | StringFormatFlags.LineLimit | StringFormatFlags.NoClip;
                ...
                RectangleF TitleRectangle = new RectangleF((float)LeftMargin, CurrentY, (float)PageWidth - (float)RightMargin - (float)LeftMargin, g.MeasureString(TheFottertext, TheTitleFont).Height);
                //if (TitleRectangle.Height + endofprint < PageHeight)
                CurrentY += TitleRectangle.Height;
                if ((int)CurrentY < (PageHeight - TopMargin - BottomMargin))
                {
                    g.DrawString(TheFottertext, TheTitleFont, new SolidBrush(TheTitleColor), TitleRectangle, TitleFormat);
                }
                else
                {
                    //CurrentRow++;
            ...
            //    RectangleF TitleRectangle = new RectangleF((float)LeftMargin, endofprint, (float)PageWidth - (float)RightMargin - (float)LeftMargin, g.MeasureString(TheFottertext, TheTitleFont).Height);
            //    if (TitleRectangle.Height + endofprint < PageHeight)
            //        g.DrawString(TheFottertext, TheTitleFont, new SolidBrush(TheTitleColor), TitleRectangle, TitleFormat);
            //    else
            //    {
            ...
            //    //CurrentY += g.MeasureString(TheTitleText, TheTitleFont).Height;
            ////}
            //if (endofprint <= PageHeight - 3)
            //    g.DrawString(TheFottertext, TheTitleFont, Brushes.Black, 200, endofprint);
            //else
            //    g.DrawString(TheFottertext, TheTitleFont, Brushes.Black, 200, PageHeight - 3);
